...
public class HelloWorldServer extends CoapServer {
	...
	class HelloWorldResource extends CoapResource {
		...
		public void handleGET(CoapExchange exchange) {
			...
			NodeDto nodeDto = new NodeDto(1, (float) (Math.random() * 50 + 1),(float) (Math.random() * 50 + 1), (float) (Math.random() * 50 + 1), 2, 1);
			String temp = new Gson().toJson(nodeDto);
			
			exchange.respond(temp);
			//exchange.respond("anh sang khong khi");
		}
	}
}
